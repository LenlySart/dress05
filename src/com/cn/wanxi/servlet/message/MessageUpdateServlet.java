 ...
 * @author Dshzs月
 * @version 1.0.0
 * @ClassName messageUpdateServlet.java
 * @Description TODO
 * @createTime 2021年12月14日 13:53:00
 */
@WebServlet("/back/message/update")
...
//        封装数据
        ...
        message.setVisitorEmail(visitorEmail);
        message.setState(Tool.stringToInt(state));

//        创建一个业务层
        MessageService messageService = new MessageServiceImpl();
//        调用业务层查获取询数据
        ResultModel resultModel = messageService.update(message);
//        返回数据到前端
