 ...
 * @author Dshzs月
 * @version 1.0.0
 * @ClassName UserFandAllServlet.java
 * @Description TODO
 * @createTime 2021年12月08日 18:19:00
 */
@WebServlet("/back/user/fndAll")
public class UserFndAllServlet extends HttpServlet {
    @Override
...
//        调用业务层查获取询数据
        ResultModel resultModel = userService.getfindAll(user);
//        返回数据到前端
